...
all: pic meminit memlist memfetch memclean memdumpclean
meminit:
	$(CCX64) $(COMINCLUDE) -o ./bin/InstallHooks.o -Os -c ./BOF/src/InstallHooks.c -DBOF
memlist:
	$(CCX64) $(COMINCLUDE) -o ./bin/MemList.o -Os -c ./BOF/src/MemList.c -DBOF
memfetch:
	$(CCX64) $(COMINCLUDE) -o ./bin/MemFetch.o -Os -c ./BOF/src/MemFetch.c -DBOF
memclean:
	$(CCX64) $(COMINCLUDE) -o ./bin/MemClean.o -Os -c ./BOF/src/MemClean.c -DBOF
memdumpclean:
	$(CCX64) $(COMINCLUDE) -o ./bin/MemDumpClean.o -Os -c ./BOF/src/MemDumpClean.c -DBOF
pic:
